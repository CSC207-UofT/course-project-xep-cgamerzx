...
Note that for our specific implementation, I/O functions for communicating with the underlying SQLite database are autogenerated by the Room persistence library during complilation such that we do not need to write them ourselves.
